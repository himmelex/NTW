...
class ImageFile
{
    ...
    function resize($size, $outname, $outpath)
    {
    	$w = $this->width;
    	$h = $this->height;
        ...
        imagecopyresampled($image_dest, $image_src, 0, 0, 0, 0, $w, $h, $this->width, $this->height);
    ...
    function resizeAvatar($size, $x = 0, $y = 0, $w = null, $h = null)
    {
