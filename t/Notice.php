...
class Notice extends Memcached_DataObject
{
    ...
    public $content;                         // blob(65535)  multiple_key blob
    ...
    public $reply_to;                        // int(11)  multiple_key
    public $is_local;                        // int(4)  
    public $source;                          // string(32)  
    public $conversation;                    // int(11)  multiple_key
    public $lat;                             // real(12)  
    public $lon;                             // real(12)  
    public $location_id;                     // int(11)  
    public $location_ns;                     // int(11)  
    public $repeat_of;                       // int(11)  multiple_key
