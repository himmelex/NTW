...
class Config extends Memcached_DataObject
{
    ...
    public $section;                         // string(32)  not_null primary_key binary
    public $setting;                         // string(32)  not_null primary_key binary
    public $value;                           // string(255)  binary

    /* Static get */
    function staticGet($k,$v=NULL) { return DB_DataObject::staticGet('Config',$k,$v); }
