...
class File_oembed extends Memcached_DataObject
{
    ...
    public $file_id;                         // int(11)  not_null primary_key
    public $version;                         // string(20)  
    public $type;                            // string(20)  
    public $mimetype;                        // string(50)  
    public $provider;                        // string(50)  
    public $provider_url;                    // string(255)  
    public $width;                           // int(11)  
    public $height;                          // int(11)  
    public $html;                            // blob(65535)  blob
    public $title;                           // string(255)  
    public $author_name;                     // string(50)  
    public $author_url;                      // string(255)  
